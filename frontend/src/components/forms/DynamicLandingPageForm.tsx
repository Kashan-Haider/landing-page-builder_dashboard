          ...
          <div
            ...
            onFocus={(e) => {
              e.target.parentElement?.style.setProperty(
                "box-shadow",
                "0 0 0 3px rgba(124, 156, 196, 0.1)"
              );
            }}
            onBlur={(e) => {
              e.target.parentElement?.style.setProperty("box-shadow", "none");
            }}
          />
        </label>
        <span
...
// Component for Images Array
const ImagesArrayInput: React.FC<{
  label: string;
  value: any[] | undefined;
  ...
  const updateImage = (index: number, field: string, newValue: any) => {
  ...
  return (
    <div className="space-y-4">
        ...
        <div key={index} className="card-metallic p-4 space-y-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-2">
              <button
                ...
                className="px-3 py-1 rounded text-sm transition-all duration-300 border"
                style={{
                  color: "var(--error)",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <TextInput
              ...
              onChange={(val) => updateImage(index, "slotName", val)}
              placeholder="e.g., hero-banner, logo, gallery-1"
            />
            <TextInput
              label="Title"
              value={image.title}
          ...
          <TextInput
            label="Alt Text"
            value={image.altText}
            onChange={(val) => updateImage(index, "altText", val)}
          ...
          <div className="space-y-2">
            <TextInput
              ...
              onChange={(val) => updateImage(index, "imageUrl", val)}
      ...
      <button
        type="button"
        onClick={addImage}
        className="btn-metallic px-4 py-2 rounded-lg text-sm font-medium inline-flex items-center"
      >
        <svg
...
export const DynamicLandingPageForm: React.FC<DynamicLandingPageFormProps> = ({
  ...
  const sections = [
    ...
    },
    {
      id: "images",
      label: "Images",
      description: "All Images being used in this website",
    },
  ];
  ...
  const renderSectionContent = (section: (typeof sections)[0]) => {
    switch (section.id) {
      case "basic":
        return (
          <div className="space-y-6">
            <h3 className="text-xl font-bold silver-text mb-6">
              Basic Information
            </h3>
            <TextInput
              label="Business Name"
        ...
        return (
          <div className="space-y-6">
            ...
            <TextInput
              ...
              onChange={(value) =>
                handleFieldChange("seoData.description", value)
              }
            ...
            <ArrayInput
              ...
              value={getNestedValue(localData, "seoData.focusedKeywords")}
              onChange={(value) =>
                handleFieldChange("seoData.focusedKeywords", value)
              }
              placeholder="Enter a focused keyword"
            />
            <TextInput
              label="Canonical Url"
              value={getNestedValue(localData, "seoData.canonicalUrl")}
              onChange={(value) =>
                handleFieldChange("seoData.canonicalUrl", value)
              }
              placeholder="Enter the canonical Url"
            />
            <BooleanInput
              label="Index"
              value={getNestedValue(localData, "seoData.isIndex")}
              onChange={(value) => handleFieldChange("seoData.isIndex", value)}
              description="This value handles the index value of Robot.txt"
            />
          </div>
        );
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <TextInput
                ...
                onChange={(value) =>
                  handleFieldChange("themeData.primaryColor", value)
                }
                placeholder="#3B82F6"
              />
              <TextInput
                ...
                onChange={(value) =>
                  handleFieldChange("themeData.secondaryColor", value)
                }
                placeholder="#10B981"
              />
            </div>
            <TextInput
              ...
              onChange={(value) =>
                handleFieldChange("themeData.fontFamily", value)
              }
            ...
            <TextInput
              ...
              onChange={(value) =>
                handleFieldChange("themeData.logoUrl", value)
              }
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <TextInput
                  ...
                  onChange={(value) =>
                    handleFieldChange("businessData.phone", value)
                  }
                ...
                <TextInput
                  ...
                  onChange={(value) =>
                    handleFieldChange("businessData.email", value)
                  }
              ...
              <div className="grid grid-cols-2 gap-4">
                <TextInput
                  ...
                  value={getNestedValue(
                    localData,
                    "businessData.emergencyPhone"
                  )}
                  onChange={(value) =>
                    handleFieldChange("businessData.emergencyPhone", value)
                  }
                ...
                <TextInput
                  ...
                  value={getNestedValue(
                    localData,
                    "businessData.emergencyEmail"
                  )}
                  onChange={(value) =>
                    handleFieldChange("businessData.emergencyEmail", value)
                  }
            ...
            <div className="space-y-4">
              ...
              <TextInput
                ...
                onChange={(value) =>
                  handleFieldChange("businessData.address.street", value)
                }
              ...
              <div className="grid grid-cols-2 gap-4">
                <TextInput
                  ...
                  onChange={(value) =>
                    handleFieldChange("businessData.address.city", value)
                  }
                ...
                <TextInput
                  ...
                  onChange={(value) =>
                    handleFieldChange("businessData.address.state", value)
                  }
                  placeholder="NY"
                />
              </div>
              <div className="grid grid-cols-2 gap-4">
                <TextInput
                  ...
                  onChange={(value) =>
                    handleFieldChange("businessData.address.zipCode", value)
                  }
                  placeholder="10001"
                />
                <TextInput
                  ...
                  onChange={(value) =>
                    handleFieldChange("businessData.address.country", value)
                  }
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <TextInput
                ...
                onChange={(value) =>
                  handleFieldChange("content.hero.title", value)
                }
              ...
              <TextInput
                ...
                onChange={(value) =>
                  handleFieldChange("content.hero.subtitle", value)
                }
              ...
              <TextInput
                ...
                onChange={(value) =>
                  handleFieldChange("content.hero.description", value)
                }
            ...
            <div className="space-y-4">
              ...
              <TextInput
                ...
                onChange={(value) =>
                  handleFieldChange("content.about.title", value)
                }
              ...
              <TextInput
                ...
                onChange={(value) =>
                  handleFieldChange("content.about.description", value)
                }
              ...
              <ArrayInput
                ...
                onChange={(value) =>
                  handleFieldChange("content.about.features", value)
                }
            ...
            <div className="space-y-4">
              ...
              <TextInput
                ...
                onChange={(value) =>
                  handleFieldChange("content.services.title", value)
                }
              ...
              <TextInput
                ...
                onChange={(value) =>
                  handleFieldChange("content.services.description", value)
                }
            ...
            <div className="space-y-4">
              ...
              <TextInput
                ...
                onChange={(value) =>
                  handleFieldChange("content.gallery.title", value)
                }
              ...
              <TextInput
                ...
                onChange={(value) =>
                  handleFieldChange("content.gallery.description", value)
                }
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <ServicesArrayInput
                  ...
                  onChange={(value) =>
                    handleFieldChange("content.services.services", value)
                  }
                />
              </div>
              ...
              <div className="space-y-4">
                ...
                <TextInput
                  ...
                  onChange={(value) =>
                    handleFieldChange("content.testimonials.title", value)
                  }
                ...
                <TextInput
                  ...
                  onChange={(value) =>
                    handleFieldChange("content.testimonials.description", value)
                  }
              ...
              <div className="space-y-4">
                ...
                <TextInput
                  ...
                  onChange={(value) =>
                    handleFieldChange("content.faq.title", value)
                  }
                ...
                <TextInput
                  ...
                  onChange={(value) =>
                    handleFieldChange("content.faq.description", value)
                  }
                ...
                <FAQArrayInput
                  ...
                  onChange={(value) =>
                    handleFieldChange("content.faq.questions", value)
                  }
                />
              </div>
              ...
              <div className="space-y-4">
                ...
                <SocialLinksInput
                  ...
                  onChange={(value) =>
                    handleFieldChange("businessData.socialLinks", value)
                  }
                />
              </div>
              ...
              <div className="space-y-4">
                ...
                <ServiceAreasInput
                  ...
                  onChange={(value) =>
                    handleFieldChange("businessData.serviceAreas", value)
                  }
                />
              </div>
              ...
              <div className="space-y-4">
                ...
                <TextInput
                  ...
                  onChange={(value) =>
                    handleFieldChange("content.contact.title", value)
                  }
                ...
                <TextInput
                  ...
                  onChange={(value) =>
                    handleFieldChange("content.contact.description", value)
                  }
              ...
              <div className="space-y-4">
                ...
                <TextInput
                  ...
                  onChange={(value) =>
                    handleFieldChange("content.footer.copyright", value)
                  }
      ...
      case "images":
        return (
          <div className="space-y-6">
            <h3 className="text-xl font-bold silver-text mb-6">Images</h3>
            <ImagesArrayInput
              label="Images Urls"
              value={landingPage.images}
              onChange={(value) =>
                handleFieldChange("landingPage.images", value)
              }
            />
          </div>
        );
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between py-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold silver-text">
                  Advanced Landing Page Editor
                </h1>
                <p
                  className="text-sm mt-1"
                  style={{ color: "var(--text-tertiary)" }}
                >
                  Customize every aspect of your landing page with our
            ...
            <div className="card-metallic">
              {sections.map((section) => (
                <div
                  key={section.id}
                  className={
                    activeSection === section.id ? "block p-8" : "hidden"
                  }
                >
