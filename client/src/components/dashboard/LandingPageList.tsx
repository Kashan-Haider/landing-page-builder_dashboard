      ...
      <div className="card-metallic">
        <div className="px-6 py-6">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-xl font-semibold silver-text">
              Landing Pages
            </h3>
          ...
          <div className="text-center py-8">
            ...
            <p className="text-sm" style={{ color: 'var(--text-muted)' }}>No landing pages found</p>
          </div>
        </div>
      </div>
    );
        ...
        <div className="space-y-3 max-h-96 overflow-y-auto">
          {pages.map((page) => (
            <div
              ...
              style={{
                borderColor: selectedPage?.id === page.id ? 'var(--accent-primary)' : 'var(--border-secondary)',
                transform: selectedPage?.id === page.id ? 'translateY(-1px)' : 'none'
              }}
            ...
            >
              <div
                ...
                style={{ 
                  color: selectedPage?.id === page.id ? 'var(--text-primary)' : 'var(--text-primary)'
                }}
              >
                {page.businessName}
              </div>
              <div
                ...
                style={{ 
                  color: selectedPage?.id === page.id ? 'var(--text-secondary)' : 'var(--text-tertiary)'
                }}
              >
              ...
              <div
                ...
                style={{ 
                  color: selectedPage?.id === page.id ? 'var(--text-secondary)' : 'var(--text-muted)'
                }}
              >
                <svg
                  className="w-3 h-3"
